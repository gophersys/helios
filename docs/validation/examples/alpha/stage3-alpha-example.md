...
The goal is to make the abstract framework described in [00-validation-philosophy.md](../../architecture/00-validation-philosophy.md) Section 3.3 concrete by showing every layer for a real product.
