...
stage4-fuota-validation-flow.md) requires
...
| Stage 4 FUOTA Flow | `docs/architecture/validation/stage4-fuota-flow.md` (internal) |
| Stage 4 Product Tests | `docs/architecture/validation/stage4-product-tests.md` |
