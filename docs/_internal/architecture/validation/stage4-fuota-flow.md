...
> [corecloud-library-architecture.md](../platform/corecloud-library.md) for the
...
2. **CoreCloud FUOTA REST endpoints**: The Python SDK has no REST methods for
   ...
   [corecloud-library-architecture.md](../platform/corecloud-library.md) Section 4.5
...
| [corecloud-library-architecture.md](../platform/corecloud-library.md) | CoreCloud Python SDK analysis: module inventory, proposed `fuota.py` + `device_management.py` modules, DB ORM vs REST strategy, and open questions. Section 7 details the FUOTA ORM access pattern used in Section 9 of this document. |
| [00-validation-philosophy.md](../../vision/validation-philosophy.md) | Stage 4 is the top of the testing pyramid -- slowest, most expensive, runs on real hardware. |
| [09-final-architecture.md](./system.md) | Pipeline controller, build service, and K8s orchestration that drives this flow. |
...
| [alpha-prdtst-reference.md](../../reference/alpha-test-cases.md) | PRDTST test case catalog -- the acceptance criteria for Steps 7 and 10. |
| [test-runner-stack.md](./test-runner.md) | Test runner stack: how PRD tests map through TestContext, CloudClient, FixtureController, and MTIB V2 to infrastructure. Shows concrete code walk-throughs for FUOTA and other test domains. |
| [../project/bom-system-implementation.md](../../_archive/project/bom-system-implementation.md) | System-level BOM: interface agreements, FUOTA component inventory (§5), effort summary, blocked items. |
