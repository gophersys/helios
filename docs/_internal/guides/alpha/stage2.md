...
The goal is to make the abstract Stage 2 framework described in [00-validation-philosophy.md](../../vision/validation-philosophy.md) Section 3.2 concrete, using a real driver and real pin assignments from the Alpha hardware.
...
5. **Execute**: The Stage 2 test runner (a container in a K8s pod) runs the flow described in [09-final-architecture.md](../../architecture/validation/system.md) Section 3.2:
