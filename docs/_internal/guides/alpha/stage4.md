# Stage 4 Alpha Example — Regression Product Validation

> Step-by-step walkthrough of Stage 4 (Regression) validation for the Alpha B0 device.
...
Stage 4 Regression is **comprehensive black-box product validation**. Unlike Stage 5 Gate (which focuses on FUOTA and fast feedback), Regression runs all the slow tests that can't fit in a 15-minute PR gate.
...
- **Driver internals** — Stage 2 Driver covers this
...
class TestPowerProfile:
    """REGRESSION-ALPHA-PWR: Power profiling tests."""

    def test_sleep_current(self, ctx):
        """REGRESSION-ALPHA-PWR-001: Sleep current < 50uA."""
    ...
    def test_active_current(self, ctx):
        """REGRESSION-ALPHA-PWR-002: Active current < 15mA (sensors sampling)."""
    ...
    def test_modem_burst_current(self, ctx):
        """REGRESSION-ALPHA-PWR-003: Modem TX burst < 300mA peak."""
...
class TestSensors:
    """REGRESSION-ALPHA-SENS: Sensor characterization tests."""

    def test_accelerometer_range(self, ctx):
        """REGRESSION-ALPHA-SENS-001: Accelerometer reads gravity correctly."""
    ...
    def test_ppg_skin_detection(self, ctx):
        """REGRESSION-ALPHA-SENS-002: PPG detects on-skin stimulus."""
    ...
    def test_temperature_sensor(self, ctx):
        """REGRESSION-ALPHA-SENS-003: Temperature sensor within range."""
    ...
    def test_pressure_sensor(self, ctx):
        """REGRESSION-ALPHA-SENS-004: Pressure sensor within range."""
        msg = ctx.cloud.wait_for_message("EnvironmentMsgV1", timeout_s=60)
...
class TestGPS:
    """REGRESSION-ALPHA-GPS: GPS acquisition tests."""

    def test_cold_start_ttff(self, ctx):
        """REGRESSION-ALPHA-GPS-001: Cold start TTFF < 60 seconds."""
    ...
    def test_warm_start_ttff(self, ctx):
        """REGRESSION-ALPHA-GPS-002: Warm start TTFF < 10 seconds."""
...
@pytest.mark.timeout(600)  # 10 min
class TestCharger:
    """REGRESSION-ALPHA-CHG: Charger behavior tests."""

    def test_charger_detect(self, ctx):
        """REGRESSION-ALPHA-CHG-001: Device detects charger connection."""
    ...
    def test_charger_disconnect(self, ctx):
        """REGRESSION-ALPHA-CHG-002: Device detects charger disconnection."""
    ...
    def test_charge_current(self, ctx):
        """REGRESSION-ALPHA-CHG-003: Charge current within spec."""
        ctx.fixture.charger_on()
        time.sleep(10)
...
@pytest.mark.timeout(600)  # 10 min
class TestStimulus:
    """REGRESSION-ALPHA-STIM: Physical stimulus tests."""

    def test_button_short_press(self, ctx):
        """REGRESSION-ALPHA-STIM-001: Short button press triggers state change."""
    ...
    def test_button_long_press(self, ctx):
        """REGRESSION-ALPHA-STIM-002: Long button press triggers SOS/shutdown."""
    ...
    def test_motion_detection(self, ctx):
        """REGRESSION-ALPHA-STIM-003: Motion stage triggers motion event."""
...
kind: CronJob
metadata:
  name: validation-alpha-regression
spec:
...
| Aspect | Stage 4 Regression | Stage 5 Gate |
|--------|-----------------|--------------|
| Duration | 30-60 min | < 15 min |
| Trigger | Regression cron | Every PR |
| Blocks merge | No | **Yes** |
| FUOTA | No | **Yes** |
