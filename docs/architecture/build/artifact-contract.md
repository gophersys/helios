...
- [Product & Build System](product-build-system.md) — build config model and two-layer architecture
- [Build Service](build-service.md) — current build orchestrator (gRPC + HTTP)
- [FUOTA Workflow](../../reference/fuota-workflow.md) — CFW consumption by the FUOTA system
- [Stages Overview](../validation/stages-overview.md) — what each validation stage tests
- [Test Runner](../validation/test-runner.md) — test execution architecture
