...
```python
# apps/backend/build-service/src/providers/grpc_server.py
...
```python
# apps/backend/build-service/src/providers/http_server.py
...
```python
# apps/backend/build-service/src/main.py
...
3. Implement `apps/backend/build-service/` with `BuildEngine` + gRPC + HTTP servers
