...
[corecloud-library-architecture.md](../platform/corecloud-library.md) Section 4.3 for
...
> [corecloud-library-architecture.md](../platform/corecloud-library.md) Sections 4
