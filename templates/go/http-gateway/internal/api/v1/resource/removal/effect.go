...
// effect builds the after-respond Action: a fire-and-forget delete-audit Event naming the caller and
// the resource removed. It runs AFTER the 200 Envelope is written, so its error is logged, never
