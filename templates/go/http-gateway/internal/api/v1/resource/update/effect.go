...
// effect builds the after-respond Action: a fire-and-forget update-audit Event naming the caller and
// the resource updated. It runs AFTER the 200 Envelope is written, so its error is logged, never
