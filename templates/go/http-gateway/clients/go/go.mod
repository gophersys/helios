// Module github.com/gophersys/libs/templates/go/http-gateway/clients/go — the typed Go
...
module github.com/gophersys/libs/templates/go/http-gateway/clients/go
