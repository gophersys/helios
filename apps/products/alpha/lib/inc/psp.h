...
*  This Software Library is provided to CoreKinect LLC for use under and subject to the terms of the Evaluation License Agreement dated 10 Jul 2024.
...
typedef struct psp_inst_params_tag
{
    ...
    FX_SINT16             calCoefSpO2[3];   /**< array of SpO2 calibration coefficients: a, b, c  , scaled with factor 100 */ 
    FX_UINT08             alarmRateFall;    /**< false alarm rate for fall:  0: once per day, 1: once per week, 2: once per month */
