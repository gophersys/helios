...
//1. Read Ta and To temperature data in register 0x0A to 0x0D and status flag in 
//   register 0x05.
...
//=================================================================================================
void gpio_alert_isr(void)
{
	_alert_pin_flag = true;	
}
//=================================================================================================
