...
@clusters_deployments_apply_uuid_bp.route(
    "/v1/clusters/<cluster_uuid>/deployments/<deployment_uuid>/apply", methods=["POST"]
)
@authMiddleware.check_permissions(["Concord.Cluster.Deployment.Apply"])
