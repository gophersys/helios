...
#                                                                              Init
# -------------------------------------------------------------------------------*/
def post_app_test_init(config: Sigma5ManufacturingConfig, nodes: List[str], usr_data: None) -> str:
...
#                                                                            Deinit
# -------------------------------------------------------------------------------*/
def post_app_test_deinit(config: Sigma5ManufacturingConfig, nodes: List[str], usr_data: None) -> str:
...
post_app_test: Test = Test(
    ...
    init_func=post_app_test_init,
    deinit_func=post_app_test_deinit,
    usr_data=None,
    usr_data_type=None,
    steps=[
