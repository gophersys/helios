...
def fw_flash_test_init(config: Sigma5ManufacturingConfig, nodes: List[str], usr_data: None) -> str:
    ...
    def init_node(node: str) -> str:
        ...
        fw_files = [
            config.post_fw_flash_test_nrf9160_modem_fw_name,
            config.post_fw_flash_test_nrf9160_app_fw_name,
            config.post_fw_flash_test_nrf52840_app_fw_name,
        ]
...
#                                                                              Test
# -------------------------------------------------------------------------------*/
post_fw_flash_test: Test = Test(
    # Test metadata
    info=TestInfo(
        name="POST Firmware Flashing Test",
