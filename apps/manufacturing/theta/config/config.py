...
class Config:
    ...
    POST_FW_FLASH_TEST_PORT: int
    POST_FW_FLASH_TEST_UUID: str
    POST_TEST_PORT: int
    POST_TEST_UUID: str
    PROD_FW_FLASH_TEST_PORT: int
    PROD_FW_FLASH_TEST_UUID: str
    ...
    def _initialize(self) -> None:
        ...
        self.POST_FW_FLASH_TEST_PORT = self._get_env_var("POST_FW_FLASH_TEST_PORT", int)
        self.POST_FW_FLASH_TEST_UUID = self._get_env_var("POST_FW_FLASH_TEST_UUID", str)
        self.POST_TEST_PORT = self._get_env_var("POST_TEST_PORT", int)
        self.POST_TEST_UUID = self._get_env_var("POST_TEST_UUID", str)
        self.PROD_FW_FLASH_TEST_PORT = self._get_env_var("PROD_FW_FLASH_TEST_PORT", int)
        self.PROD_FW_FLASH_TEST_UUID = self._get_env_var("PROD_FW_FLASH_TEST_UUID", str)
