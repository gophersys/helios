...
def test_run_create_valid():
    from src.api.v2.runs.types import RunCreateRequest
...
def test_report_start_valid():
    from src.api.v2.runs.types import ReportStartRequest
...
def test_report_test_start_valid():
    from src.api.v2.runs.types import ReportTestStartRequest
...
def test_report_test_result_valid():
    from src.api.v2.runs.types import ReportTestResultRequest
...
def test_report_finish_valid():
    from src.api.v2.runs.types import ReportFinishRequest
