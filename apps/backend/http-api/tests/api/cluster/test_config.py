...
class TestListConfigMaps:
    ...
    @patch("api.v2.system.config.config_svc.list_configmaps")
    def test_list_configmaps_success(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/configmaps")
    ...
    def test_list_configmaps_with_namespace(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/configmaps?namespace=staging")
        assert response.status_code == 200
    ...
    def test_list_configmaps_with_label_selector(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/configmaps?labelSelector=app%3Dconcord")
        assert response.status_code == 200
    ...
    def test_list_configmaps_with_namespace_and_label_selector(self, mock_list, authed_client):
        ...
        response = authed_client.get(
            "/v2/cluster/configmaps?namespace=staging&labelSelector=tier%3Dbackend"
        )
        assert response.status_code == 200
    ...
    def test_list_configmaps_requires_auth(self, client):
        ...
        response = client.get("/v2/cluster/configmaps")
...
class TestGetConfigMap:
    ...
    @patch("api.v2.system.config.config_svc.get_configmap")
    def test_get_configmap_success(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/configmaps/staging/app-config")
        assert response.status_code == 200
    ...
    def test_get_configmap_not_found(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/configmaps/staging/nonexistent")
    ...
    def test_get_configmap_k8s_api_404(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/configmaps/staging/missing")
        assert response.status_code == 404

    def test_get_configmap_invalid_namespace(self, authed_client):
        """Should return 400 for invalid namespace name."""
        response = authed_client.get("/v2/cluster/configmaps/BAD_NS/app-config")
...
class TestListSecrets:
    ...
    @patch("api.v2.system.config.config_svc.list_secrets")
    def test_list_secrets_success(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/secrets")
        assert response.status_code == 200
    ...
    def test_list_secrets_with_namespace(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/secrets?namespace=production")
        assert response.status_code == 200
    ...
    def test_list_secrets_with_label_selector(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/secrets?labelSelector=app%3Dconcord")
        assert response.status_code == 200
    ...
    def test_list_secrets_with_namespace_and_label_selector(self, mock_list, authed_client):
        ...
        response = authed_client.get(
            "/v2/cluster/secrets?namespace=production&labelSelector=tier%3Dbackend"
        )
        assert response.status_code == 200
    ...
    def test_list_secrets_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.get("/v2/cluster/secrets")
        assert response.status_code == 401
...
class TestGetSecret:
    ...
    @patch("api.v2.system.config.config_svc.get_secret")
    @patch("api.v2.system.config.log_audit")
    def test_get_secret_success(self, mock_audit, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/secrets/staging/db-credentials")
        assert response.status_code == 200
    ...
    def test_get_secret_not_found(self, mock_get, mock_audit, authed_client):
        ...
        response = authed_client.get("/v2/cluster/secrets/staging/nonexistent")
        assert response.status_code == 404

    def test_get_secret_invalid_namespace(self, authed_client):
        """Should return 400 for invalid namespace name."""
        response = authed_client.get("/v2/cluster/secrets/BAD_NS/db-credentials")
        assert response.status_code == 400

    def test_get_secret_invalid_name(self, authed_client):
        """Should return 400 for invalid secret name."""
        response = authed_client.get("/v2/cluster/secrets/staging/BAD_NAME!")
        assert response.status_code == 400
