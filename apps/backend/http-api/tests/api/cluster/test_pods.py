...
class TestListPods:
    ...
    @patch("api.v2.kubernetes.pods.pods_svc.list_pods")
    def test_list_pods_success(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods")
    ...
    def test_list_pods_with_namespace_filter(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods?namespace=production")
        assert response.status_code == 200
    ...
    def test_list_pods_with_label_selector(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods?labelSelector=app=http-api")
        assert response.status_code == 200
    ...
    def test_list_pods_respects_limit(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods?limit=3")
        assert response.status_code == 200
    ...
    def test_list_pods_pagination_page_2(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods?page=2&limit=3")
        assert response.status_code == 200
    ...
    def test_list_pods_limit_clamped_max(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods?limit=5000")
        assert response.status_code == 200
    ...
    def test_list_pods_limit_clamped_min(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods?limit=0")
        assert response.status_code == 200
...
class TestGetPod:
    ...
    @patch("api.v2.kubernetes.pods.pods_svc.get_pod")
    def test_get_pod_success(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/staging/http-api-abc12")
        assert response.status_code == 200
    ...
    def test_get_pod_not_found(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/staging/nonexistent-pod")
    ...
    def test_get_pod_k8s_api_404(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/staging/missing-pod")
        assert response.status_code == 404
    ...
    def test_get_pod_invalid_namespace(self, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/INVALID_NS/some-pod")
        assert response.status_code == 400

    def test_get_pod_invalid_name(self, authed_client):
        """Should return 400 for invalid pod name."""
        response = authed_client.get("/v2/kubernetes/pods/staging/INVALID_NAME!")
        assert response.status_code == 400
...
class TestGetPodLogs:
    ...
    @patch("api.v2.kubernetes.pods.pods_svc.get_pod_logs")
    def test_get_pod_logs_success(self, mock_logs, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/staging/http-api-abc12/logs")
        assert response.status_code == 200
    ...
    def test_get_pod_logs_not_found(self, mock_logs, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/staging/nonexistent-pod/logs")
        assert response.status_code == 404
    ...
    def test_get_pod_logs_with_container(self, mock_logs, authed_client):
        ...
        response = authed_client.get(
            "/v2/kubernetes/pods/staging/multi-container-pod/logs?container=sidecar"
        )
        assert response.status_code == 200
    ...
    def test_get_pod_logs_with_tail_lines(self, mock_logs, authed_client):
        ...
        response = authed_client.get(
            "/v2/kubernetes/pods/staging/http-api-abc12/logs?tailLines=10"
        )
        assert response.status_code == 200
    ...
    def test_get_pod_logs_previous(self, mock_logs, authed_client):
        ...
        response = authed_client.get(
            "/v2/kubernetes/pods/staging/http-api-abc12/logs?previous=true"
        )
        assert response.status_code == 200
    ...
    def test_get_pod_logs_k8s_api_404(self, mock_logs, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/staging/missing-pod/logs")
        assert response.status_code == 404
    ...
    def test_get_pod_logs_invalid_namespace(self, authed_client):
        ...
        response = authed_client.get("/v2/kubernetes/pods/INVALID_NS/some-pod/logs")
        assert response.status_code == 400

    def test_get_pod_logs_invalid_name(self, authed_client):
        """Should return 400 for invalid pod name."""
        response = authed_client.get("/v2/kubernetes/pods/staging/INVALID_NAME!/logs")
        assert response.status_code == 400

    def test_get_pod_logs_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.get("/v2/kubernetes/pods/staging/http-api-abc12/logs")
        assert response.status_code == 401
...
class TestDeletePod:
    ...
    @patch("api.v2.kubernetes.pods.log_audit")
    @patch("api.v2.kubernetes.pods.pods_svc.delete_pod")
    def test_delete_pod_success(self, mock_delete, mock_audit, authed_client):
        ...
        response = authed_client.delete("/v2/kubernetes/pods/staging/http-api-abc12")
        assert response.status_code == 200
    ...
    def test_delete_pod_not_found(self, mock_delete, authed_client):
        ...
        response = authed_client.delete("/v2/kubernetes/pods/staging/missing-pod")
        assert response.status_code == 404

    def test_delete_pod_invalid_namespace(self, authed_client):
        """Should return 400 for invalid namespace."""
        response = authed_client.delete("/v2/kubernetes/pods/BAD_NS/some-pod")
        assert response.status_code == 400

    def test_delete_pod_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.delete("/v2/kubernetes/pods/staging/http-api-abc12")
        assert response.status_code == 401
