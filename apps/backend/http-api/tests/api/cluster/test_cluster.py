...
class TestClusterInfo:
    ...
    @patch("api.v2.system.cluster.get_cluster_info")
    def test_cluster_info_success(self, mock_get_info, authed_client):
        ...
        response = authed_client.get("/v2/cluster/info")
...
class TestClusterNamespaces:
    ...
    @patch("api.v2.system.cluster.list_namespaces")
    def test_list_namespaces_success(self, mock_list_ns, authed_client):
        ...
        response = authed_client.get("/v2/cluster/namespaces")
        assert response.status_code == 200
    ...
    def test_list_namespaces_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.get("/v2/cluster/namespaces")
        assert response.status_code == 401
...
class TestClusterNodes:
    ...
    @patch("api.v2.system.nodes.nodes_svc.list_nodes")
    def test_list_nodes_success(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/nodes")
        assert response.status_code == 200
    ...
    @patch("api.v2.system.nodes.nodes_svc.get_node")
    def test_get_node_success(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/nodes/node-1")
        assert response.status_code == 200
    ...
    def test_get_node_not_found(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/nodes/nonexistent-node")
        assert response.status_code == 404
    ...
    def test_get_node_k8s_api_404(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/nodes/missing")
        assert response.status_code == 404

    def test_list_nodes_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.get("/v2/cluster/nodes")
        assert response.status_code == 401
...
class TestClusterEvents:
    ...
    @patch("api.v2.system.events.list_events")
    def test_list_events_success(self, mock_events, authed_client):
        ...
        response = authed_client.get("/v2/cluster/events")
        assert response.status_code == 200
    ...
    def test_list_events_with_namespace_filter(self, mock_events, authed_client):
        ...
        response = authed_client.get("/v2/cluster/events?namespace=staging")
        assert response.status_code == 200
    ...
    def test_list_events_with_limit(self, mock_events, authed_client):
        ...
        response = authed_client.get("/v2/cluster/events?limit=10")
        assert response.status_code == 200
    ...
    def test_list_events_limit_clamped(self, mock_events, authed_client):
        ...
        response = authed_client.get("/v2/cluster/events?limit=5000")
        assert response.status_code == 200
    ...
    def test_list_events_pagination(self, mock_events, authed_client):
        ...
        response = authed_client.get("/v2/cluster/events?page=2&limit=10")
        assert response.status_code == 200
    ...
    def test_list_events_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.get("/v2/cluster/events")
        assert response.status_code == 401
