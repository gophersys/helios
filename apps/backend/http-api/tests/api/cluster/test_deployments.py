...
class TestListDeployments:
    ...
    @patch("api.v2.system.deployments.dep_svc.list_deployments")
    def test_list_deployments_success(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/deployments")
    ...
    def test_list_deployments_with_namespace(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/deployments?namespace=production")
        assert response.status_code == 200
    ...
    def test_list_deployments_pagination_page_2(self, mock_list, authed_client):
        ...
        response = authed_client.get("/v2/cluster/deployments?page=2&limit=2")
        assert response.status_code == 200
    ...
    def test_list_deployments_label_selector(self, mock_list, authed_client):
        ...
        response = authed_client.get(
            "/v2/cluster/deployments?labelSelector=app%3Dhttp-api"
        )
        assert response.status_code == 200
    ...
    def test_list_deployments_requires_auth(self, client):
        ...
        response = client.get("/v2/cluster/deployments")
...
class TestGetDeployment:
    ...
    @patch("api.v2.system.deployments.dep_svc.get_deployment")
    def test_get_deployment_success(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/deployments/staging/http-api")
        assert response.status_code == 200
    ...
    def test_get_deployment_not_found(self, mock_get, authed_client):
        ...
        response = authed_client.get("/v2/cluster/deployments/staging/nonexistent")
...
class TestScaleDeployment:
    ...
    @patch("api.v2.system.deployments.log_audit")
    @patch("api.v2.system.deployments.dep_svc.scale_deployment")
    def test_scale_deployment_success(self, mock_scale, mock_audit, authed_client):
        ...
        response = authed_client.post(
            "/v2/cluster/deployments/staging/http-api/scale",
    ...
    def test_scale_deployment_not_found(self, mock_scale, authed_client):
        ...
        response = authed_client.post(
            "/v2/cluster/deployments/staging/missing-deploy/scale",
    ...
    def test_scale_deployment_invalid_namespace(self, authed_client):
        """Should return 400 for invalid namespace name."""
        response = authed_client.post(
            "/v2/cluster/deployments/BAD_NS/http-api/scale",
            data=json.dumps({"replicas": 2}),
        )
        assert response.status_code == 400
    ...
    def test_scale_deployment_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.post("/v2/cluster/deployments/staging/http-api/scale")
        assert response.status_code == 401
...
class TestRestartDeployment:
    ...
    @patch("api.v2.system.deployments.log_audit")
    @patch("api.v2.system.deployments.dep_svc.restart_deployment")
    def test_restart_deployment_success(self, mock_restart, mock_audit, authed_client):
        ...
        response = authed_client.post("/v2/cluster/deployments/staging/http-api/restart")
        assert response.status_code == 200
    ...
    def test_restart_deployment_not_found(self, mock_restart, authed_client):
        ...
        response = authed_client.post("/v2/cluster/deployments/staging/missing-deploy/restart")
        assert response.status_code == 404
    ...
    def test_restart_deployment_invalid_namespace(self, authed_client):
        """Should return 400 for invalid namespace name."""
        response = authed_client.post("/v2/cluster/deployments/BAD_NS/http-api/restart")
        assert response.status_code == 400

    def test_restart_deployment_requires_auth(self, client):
        """Should return 401 without authentication."""
        response = client.post("/v2/cluster/deployments/staging/http-api/restart")
        assert response.status_code == 401
