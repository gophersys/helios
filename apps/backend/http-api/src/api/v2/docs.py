...
def _build_spec() -> APISpec:
    ...
    spec.components.schema("ConcordNode", {
        ...
        "properties": {
            ...
            "disabled": {"type": "boolean", "description": "Admin override — true takes the node out of rotation"},
            "status": {
                "type": "string",
                "enum": ["ONLINE", "OFFLINE", "MAINTENANCE"],
                "description": "Computed live from K8s pod readiness; MAINTENANCE when disabled=true",
            },
            "ipAddress": {"type": "string", "nullable": True},
    ...
    path("/fixtures/benches",
        get={
            ...
            "parameters": _pagination_params + [
                ...
                {"name": "lockState", "in": "query", "schema": {"type": "string", "enum": ["FREE", "IN_USE", "MAINTENANCE"]}},
            ],
