...
def register_v2_routes(logger: Logger, server: Flask, socketio: SocketIO):
    ...
    v2.add_url_rule("/products/<product_id>/revisions/<revision_id>/modem-firmware",          view_func=list_modem_firmwares,   methods=["GET"])
    v2.add_url_rule("/products/<product_id>/revisions/<revision_id>/modem-firmware",          view_func=upload_modem_firmware,  methods=["POST"])
    v2.add_url_rule("/products/<product_id>/revisions/<revision_id>/modem-firmware/<fw_id>",  view_func=delete_modem_firmware,  methods=["DELETE"])
    ...
    v2.add_url_rule("/products/<product_id>/stages/<stage>/trigger-run",                       endpoint="trigger_stage_run",        view_func=trigger_stage_run,     methods=["POST"])
    ...
    v2.add_url_rule("/products/<product_id>/asset-sets/analyze-files",                          endpoint="analyze_asset_files",      view_func=analyze_asset_files,       methods=["POST"])
    v2.add_url_rule("/products/<product_id>/asset-sets/upload-files",                           endpoint="upload_asset_files",       view_func=upload_asset_files,        methods=["POST"])
