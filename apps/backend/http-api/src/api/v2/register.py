...
from .auth.login import v2_auth_login_bp
from .auth.me import v2_auth_me_bp
from .auth.users import v2_auth_users_bp
...
def register_v2_routes(logger: Logger, server: Flask, socketio: SocketIO):
    ...
    # Auth
    server.register_blueprint(v2_auth_login_bp)  # POST /v2/auth/login
    server.register_blueprint(v2_auth_me_bp)  # GET /v2/auth/me
    server.register_blueprint(v2_auth_users_bp)  # GET/POST /v2/auth/users, PUT/DELETE /v2/auth/users/<id>
