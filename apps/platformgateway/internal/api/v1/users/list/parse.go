...
// limit defaults to defaultLimit and a too-large one is clamped to maxLimit (a permissive default); a
// present-but-unparseable value is a typed 400 (the parse owns decoding, not silent coercion). It
// touches no port.
