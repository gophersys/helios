...
// defaultViews is the producer-declared render-plan (contract §5): each entry names one of
// the eight @eden/visualization widget primitives, binds it to a Report collection + visual
// encoding, and tags the SDLC attention point it surfaces at. A frontend iterates this list
// and instantiates the named primitive — so adding a view is data, not code.
