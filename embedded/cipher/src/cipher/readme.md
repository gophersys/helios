...
## Interfaces
Interfaces abstract away the connection management, sending and receiving of packets over the transport layer of choice. Interfaces are implemented as sets of 3 threads:
