...
def spec(font_path, **knob_row):
    row = {"plate_width": 376, "dial": 28, "tuck": 10,
           "dial_floor": 40, "label_floor": 3,
           "units": [
    ...
    row.update(knob_row)
    return {"font": {"path": font_path, "size": 16},
            "knob_rows": {"row": row}}
...
def test_flow_row_margins_and_trailing_gap(font_path):
    s = {"font": {"path": font_path, "size": 16},
         "flow_rows": {"osc": {
             "pad": 10, "right_edge": 351,
             "units": [
                 {"name": "k1", "center": 25, "box": 27, "labels": ["Coarse"]},
                 {"name": "k2", "center": 125, "box": 27, "labels": ["Fine"],
                  "widest_value": "-inf dB", "value_left_offset": 24},
             ],
