"""ui.probe_config — a panel.toml's [probe]/[rules]/[ratio] as inputs.

One panel.toml is the single source of what a panel is measured with, and
three gates read it: `ui audit`, `ui score`, and the operator demo's
...
def rules_from(cfg: dict):
    ...
    from ui.fontmetrics import Face, resolve_path
    from ui.spec import ratio_rows, rules_table
