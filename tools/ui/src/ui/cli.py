"""ui CLI — solve / audit / score / zoom / compare from the shell.
...
def cmd_score(args) -> int:
    ...
    for d, seeded in scoreable:
        ...
        print(f"ui score: {d} ({role})", file=sys.stderr)
...
def cmd_compare(args) -> int:
    from ui import compare, measure
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="ui")
