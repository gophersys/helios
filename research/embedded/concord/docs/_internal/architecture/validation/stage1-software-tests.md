...
> -- see [11-stage1-alpha-example.md](../../guides/alpha/stage1.md) for worked
...
- [00-validation-philosophy.md](../../vision/validation-philosophy.md) -- Sections 3.1, 5.1, 8
- [09-final-architecture.md](./system.md) -- Stage 1 runner spec, build service, pipeline.yaml schema
- [11-stage1-alpha-example.md](../../guides/alpha/stage1.md) -- Worked examples (reference only)
...
The full implementation follows the pattern shown in [11-stage1-alpha-example.md](../../guides/alpha/stage1.md) Section 2.4. Key details:
...
From [09-final-architecture.md](./system.md) Section 4, the Stage 1 runner:
...
The submodule override mechanism (`git submodule set-url` + `git submodule update`, or west manifest override) needs to be implemented and tested. This is described in [09-final-architecture.md](./system.md) Section 3 (Build Service) but the exact implementation is not yet specified.
