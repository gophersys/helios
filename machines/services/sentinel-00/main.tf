#
# sentinel-00 — prod tailnet bastion (OCI E2.1.Micro x86, always-free).
#
# Init:
#   terraform init \
#     -backend-config=../../../providers/state-backend/backend.hcl \
#     -backend-config=key=machines/services/sentinel-00/terraform.tfstate
#
# Import:
#   terraform import \
#     'module.instance.oci_core_instance.destroyable[0]' \
#     'ocid1.instance.oc1.phx.anyhqljtslzce6acc3d3uadohlu4ydn3bzv2afkvoyoqbgvhrtudfuaawelq'
#
...
module "instance" {
  ...
  hostname_label      = "k3s-x86-1-827047"
