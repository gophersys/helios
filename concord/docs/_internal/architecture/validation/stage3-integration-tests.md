...
> [10-stage3-alpha-example.md](../../guides/alpha/stage3.md). This document defines the
...
> [corecloud-library-architecture.md](../platform/corecloud-library.md), including
...
| Ground Mode Config V2 | `GroundModeConfigV2` | 538 | DB reads available (`.last()`, `.since_server_time()`). **REST send deferred** — class inherits `MsgBase` not `ConfMsgBase`, so `.send_via_rest()` is not available. See Section 10.6 and [corecloud-library-architecture.md](../platform/corecloud-library.md) Section 4.3. |
...
> [corecloud-library-architecture.md](../platform/corecloud-library.md) Sections 4.3-4.5
