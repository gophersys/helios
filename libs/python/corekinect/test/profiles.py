...
Note: Capability, Feature, and FEATURE_REQUIREMENTS are now defined in
``corekinect.capabilities`` and re-exported here for backward compatibility.
"""
...
# Canonical definitions — re-exported for backward compatibility
from corekinect.capabilities import (  # noqa: F401
    Capability,
    Feature,
