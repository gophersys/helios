...
func RunAdapterSuite(t *testing.T, newAdapter func() *Adapter) {
	...
	t.Run("PermissionScopeOnceReAsks", func(t *testing.T) { assertChatScopeOnceReAsks(t, newAdapter) })
	t.Run("PermissionScopeSessionWidensGrant", func(t *testing.T) { assertScopeSessionWidens(t, newAdapter) })
	t.Run("PermissionChatTimeoutConsultsAdvisor", func(t *testing.T) { assertChatTimeoutConsultsAdvisor(t, newAdapter) })
	t.Run("PermissionRiskWallClampsAdvisorAllow", func(t *testing.T) { assertRiskWallClampsAdvisor(t, newAdapter) })
	t.Run("PermissionAutonomousAdvisorConsulted", func(t *testing.T) { assertAutonomousAdvisor(t, newAdapter) })
	t.Run("PermissionAdvisorErrorDefaultDeny", func(t *testing.T) { assertAdvisorErrorDefaultDeny(t, newAdapter) })
