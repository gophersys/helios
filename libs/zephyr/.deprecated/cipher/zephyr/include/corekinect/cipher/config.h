...
typedef struct {
    ...
    tal_config_t client_ifaces[CONFIG_CK_CIPHER_CLIENT_IFACE_COUNT]; /**< The client interfaces of the host */
    size_t num_client_ifaces;                                        /**< The number of client interfaces */
    tal_config_t server_ifaces[CONFIG_CK_CIPHER_SERVER_IFACE_COUNT]; /**< The server interfaces of the host */
