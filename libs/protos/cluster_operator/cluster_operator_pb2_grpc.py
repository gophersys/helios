...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in cluster_operator_pb2_grpc.py depends on'
...
def add_ClusterOperatorServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('cluster_operator.ClusterOperator', rpc_method_handlers)
