...
LOG_MODULE_REGISTER(mtibpistm);

#define MTIBPISTM_SERVICE_ID 1
...
// Server side
static bool MtibPiStm_GpioConfigurePinHandlerImplemented = true;
__attribute__((weak)) GpioConfigurePinResponse MtibPiStm_GpioConfigurePinHandler(GpioConfigurePinRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_GpioConfigurePinHandlerImplemented = false;
...
cipher_rpc_err_t GpioConfigurePinRpcPrvHandler(void *request, void *response)
{
    ...
    *((GpioConfigurePinResponse *)response ) = MtibPiStm_GpioConfigurePinHandler(*((GpioConfigurePinRequest *)request));
    return MtibPiStm_GpioConfigurePinHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_GpioSetPinHandlerImplemented = true;
__attribute__((weak)) GpioSetPinResponse MtibPiStm_GpioSetPinHandler(GpioSetPinRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_GpioSetPinHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((GpioSetPinResponse *)response ) = MtibPiStm_GpioSetPinHandler(*((GpioSetPinRequest *)request));
    return MtibPiStm_GpioSetPinHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_GpioReadPinHandlerImplemented = true;
__attribute__((weak)) GpioReadPinResponse MtibPiStm_GpioReadPinHandler(GpioReadPinRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_GpioReadPinHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((GpioReadPinResponse *)response ) = MtibPiStm_GpioReadPinHandler(*((GpioReadPinRequest *)request));
    return MtibPiStm_GpioReadPinHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_AdcReadChannelHandlerImplemented = true;
__attribute__((weak)) AdcReadChannelResponse MtibPiStm_AdcReadChannelHandler(AdcReadChannelRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_AdcReadChannelHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((AdcReadChannelResponse *)response ) = MtibPiStm_AdcReadChannelHandler(*((AdcReadChannelRequest *)request));
    return MtibPiStm_AdcReadChannelHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_AdcReadAllChannelsHandlerImplemented = true;
__attribute__((weak)) AdcReadAllChannelsResponse MtibPiStm_AdcReadAllChannelsHandler(AdcReadAllChannelsRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_AdcReadAllChannelsHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((AdcReadAllChannelsResponse *)response ) = MtibPiStm_AdcReadAllChannelsHandler(*((AdcReadAllChannelsRequest *)request));
    return MtibPiStm_AdcReadAllChannelsHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_DutEnablePowerHandlerImplemented = true;
__attribute__((weak)) DutEnablePowerResponse MtibPiStm_DutEnablePowerHandler(DutEnablePowerRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_DutEnablePowerHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((DutEnablePowerResponse *)response ) = MtibPiStm_DutEnablePowerHandler(*((DutEnablePowerRequest *)request));
    return MtibPiStm_DutEnablePowerHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_DutEnableChargerHandlerImplemented = true;
__attribute__((weak)) DutEnableChargerResponse MtibPiStm_DutEnableChargerHandler(DutEnableChargerRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_DutEnableChargerHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((DutEnableChargerResponse *)response ) = MtibPiStm_DutEnableChargerHandler(*((DutEnableChargerRequest *)request));
    return MtibPiStm_DutEnableChargerHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_DutSetOutputVoltageHandlerImplemented = true;
__attribute__((weak)) DutSetOutputVoltageResponse MtibPiStm_DutSetOutputVoltageHandler(DutSetOutputVoltageRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_DutSetOutputVoltageHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((DutSetOutputVoltageResponse *)response ) = MtibPiStm_DutSetOutputVoltageHandler(*((DutSetOutputVoltageRequest *)request));
    return MtibPiStm_DutSetOutputVoltageHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_Ina219ReadCurrentHandlerImplemented = true;
__attribute__((weak)) Ina219ReadCurrentResponse MtibPiStm_Ina219ReadCurrentHandler(Ina219ReadCurrentRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_Ina219ReadCurrentHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((Ina219ReadCurrentResponse *)response ) = MtibPiStm_Ina219ReadCurrentHandler(*((Ina219ReadCurrentRequest *)request));
    return MtibPiStm_Ina219ReadCurrentHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_Ina219ReadVoltageHandlerImplemented = true;
__attribute__((weak)) Ina219ReadVoltageResponse MtibPiStm_Ina219ReadVoltageHandler(Ina219ReadVoltageRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_Ina219ReadVoltageHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((Ina219ReadVoltageResponse *)response ) = MtibPiStm_Ina219ReadVoltageHandler(*((Ina219ReadVoltageRequest *)request));
    return MtibPiStm_Ina219ReadVoltageHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_Ina219ReadPowerHandlerImplemented = true;
__attribute__((weak)) Ina219ReadPowerResponse MtibPiStm_Ina219ReadPowerHandler(Ina219ReadPowerRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_Ina219ReadPowerHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((Ina219ReadPowerResponse *)response ) = MtibPiStm_Ina219ReadPowerHandler(*((Ina219ReadPowerRequest *)request));
    return MtibPiStm_Ina219ReadPowerHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_Bmp390ReadValuesHandlerImplemented = true;
__attribute__((weak)) Bmp390ReadValuesResponse MtibPiStm_Bmp390ReadValuesHandler(Bmp390ReadValuesRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_Bmp390ReadValuesHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((Bmp390ReadValuesResponse *)response ) = MtibPiStm_Bmp390ReadValuesHandler(*((Bmp390ReadValuesRequest *)request));
    return MtibPiStm_Bmp390ReadValuesHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_Lis2de12ReadValuesHandlerImplemented = true;
__attribute__((weak)) Lis2de12ReadValuesResponse MtibPiStm_Lis2de12ReadValuesHandler(Lis2de12ReadValuesRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_Lis2de12ReadValuesHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((Lis2de12ReadValuesResponse *)response ) = MtibPiStm_Lis2de12ReadValuesHandler(*((Lis2de12ReadValuesRequest *)request));
    return MtibPiStm_Lis2de12ReadValuesHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_Lis2de12ReadMaxForceHandlerImplemented = true;
__attribute__((weak)) Lis2de12ReadMaxForceResponse MtibPiStm_Lis2de12ReadMaxForceHandler(Lis2de12ReadMaxForceRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_Lis2de12ReadMaxForceHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((Lis2de12ReadMaxForceResponse *)response ) = MtibPiStm_Lis2de12ReadMaxForceHandler(*((Lis2de12ReadMaxForceRequest *)request));
    return MtibPiStm_Lis2de12ReadMaxForceHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_EepromReadFromMemHandlerImplemented = true;
__attribute__((weak)) EepromReadFromMemResponse MtibPiStm_EepromReadFromMemHandler(EepromReadFromMemRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_EepromReadFromMemHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((EepromReadFromMemResponse *)response ) = MtibPiStm_EepromReadFromMemHandler(*((EepromReadFromMemRequest *)request));
    return MtibPiStm_EepromReadFromMemHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_EepromWriteToMemHandlerImplemented = true;
__attribute__((weak)) EepromWriteToMemResponse MtibPiStm_EepromWriteToMemHandler(EepromWriteToMemRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_EepromWriteToMemHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((EepromWriteToMemResponse *)response ) = MtibPiStm_EepromWriteToMemHandler(*((EepromWriteToMemRequest *)request));
    return MtibPiStm_EepromWriteToMemHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_SigmaToPiMessageHandlerImplemented = true;
__attribute__((weak)) UartMessageResponse MtibPiStm_SigmaToPiMessageHandler(UartMessageRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_SigmaToPiMessageHandlerImplemented = false;
...
{
    // Call the actual handler function
    *((UartMessageResponse *)response ) = MtibPiStm_SigmaToPiMessageHandler(*((UartMessageRequest *)request));
    return MtibPiStm_SigmaToPiMessageHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}

// Server side
static bool MtibPiStm_PiToSigmaMessageHandlerImplemented = true;
__attribute__((weak)) UartMessageResponse MtibPiStm_PiToSigmaMessageHandler(UartMessageRequest request)
{
    LOG_WRN("%s default implementation called", __func__);
    MtibPiStm_PiToSigmaMessageHandlerImplemented = false;
    UartMessageResponse response  = {0};
    return response ;
}
...
{
    // Call the actual handler function
    *((UartMessageResponse *)response ) = MtibPiStm_PiToSigmaMessageHandler(*((UartMessageRequest *)request));
    return MtibPiStm_PiToSigmaMessageHandlerImplemented ? CIPHER_RPC_ERR_OK : CIPHER_RPC_ERR_NOT_IMPLEMENTED;
}
...
static cipher_rpc_info_t mtibpistm_rpcs[] =
{
    {
...
static cipher_service_info_t mtibpistm_service =
{
    .id = MTIBPISTM_SERVICE_ID,
    .name = "MtibPiStm",
    .max_hops = 1,
    .rpcs = mtibpistm_rpcs,
    .num_rpcs = ARRAY_SIZE(mtibpistm_rpcs),
};

cipher_service_info_t *get_mtibpistmservice_info(void)
{
    return &mtibpistm_service;
}
