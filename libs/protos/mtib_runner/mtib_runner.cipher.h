...
// Server side handler
UartStreamResponse MtibRunner_nrf9160UartStreamHandler(UartStreamRequest request);

// Client side call
UartStreamResponse MtibRunner_nrf9160UartStreamRpc(cipher_unary_rpc_user_info_t *info, UartStreamRequest request);

// Server side handler
UartStreamResponse MtibRunner_nrf52840UartStreamHandler(UartStreamRequest request);
