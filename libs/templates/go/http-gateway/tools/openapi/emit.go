...
const header = `# http-gateway OpenAPI contract — GENERATED, DO NOT EDIT BY HAND (ADR-0023; OD-16-openapi=go-first-emit).
#
...
info:
  ...
  version: 0.1.0
  description: >-
    An Eden http-gateway application (ADR-0023). The contract is EMITTED from the Go route types
