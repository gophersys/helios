...
# the LOUD half of the mirroring rule.
#
...
# 2 lines in 2 files, so a bump that edits 1 of them leaves the 2 homes naming 2
# releases under 1 commit, and the diff of the pull request looks like a bump.
#
